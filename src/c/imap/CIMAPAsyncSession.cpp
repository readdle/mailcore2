...
void CIMAPAsyncSession_releaseConnection(struct CIMAPAsyncSession self, CIMAPAsyncConnection connection, unsigned int leaseGeneration, bool disconnect) {
    self.instance->releaseConnection(connection.instance, leaseGeneration, disconnect);
}
